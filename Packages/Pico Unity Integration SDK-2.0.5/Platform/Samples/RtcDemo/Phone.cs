...
namespace Pico.Platform.Samples.RtcDemo
{
    ...
    public class Phone : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            var buttonLeaveRoom = GameObject.Find("ButtonLeaveRoom").GetComponent<Button>();
            var buttonDestroyRoom = GameObject.Find("ButtonDestroyRoom").GetComponent<Button>();
            ...
            buttonDestroyRoom.onClick.AddListener(OnClickDestroyRoom);
...
");
        ...
        private void OnClickJoinRoom()
        {
            ...
            RtcService.GetToken(roomId, userId, 3600 * 2, privilege).OnComplete(msg =>
            {
                ...
                Log($"Join Success. Room Result={result} RoomId={_inputFieldRoomId.text}");
            });
        }
        ...
        private void OnJoinRoom(Message<RtcJoinRoomResult> msg)
        {
            ...
            room.leaveRoomButton = GameObject.Find("ButtonLeaveRoom").GetComponent<Button>();
            room.publishToggle = FindChild(room.GameObject, "TogglePublish").GetComponent<Toggle>();
            room.destroyRoomButton = GameObject.Find("ButtonDestroyRoom").GetComponent<Button>();
